...
public class AESToolUtil {
    ...
    public static String encodeDES(String encodeRules, String msg) {
        if (StringUtils.isBlank(encodeRules)) {
            throw new ServiceException("请输入正确加密编码");
        }
        if (StringUtils.isBlank(msg)) {
    ...
    public static void main(String[] args) throws Exception {
        String encoder = encode("12345678","我是我是我是".getBytes(StandardCharsets.UTF_8));
        String encoderdes = encodeDES("12345678","我是我是我是");
        System.out.println(encoder);
        System.out.println(encoderdes);
    }
